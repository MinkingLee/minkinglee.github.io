...
driving.setSearchCompleteCallback(function(){
    ...
    map.addOverlay(m6);
    map.addOverlay(m7);                
    var lab1 = new BMap.Label("成都,<br>四川",{position:myP1});        //创建7个label        
    var lab2 = new BMap.Label("理塘",{position:myP2});
    var lab3 = new BMap.Label("折多山",{position:myP3});        
    var lab4 = new BMap.Label("巴塘",{position:myP4});
    var lab5 = new BMap.Label("通麦大桥",{position:myP5});
    var lab6 = new BMap.Label("林芝",{position:myP6});
    var lab7 = new BMap.Label("布达拉宫,<br>西藏",{position:myP7});           
    map.addOverlay(lab1);        
    map.addOverlay(lab2);        
    map.addOverlay(lab3);
    map.addOverlay(lab4);
